            ...
            <View style={styles.view8}>
              ...
              >
                <View style={styles.button1}>
                  <Text style={styles.button1Text}>Ride with taxi move</Text>
                </View>
              </TouchableOpacity>
            </View>
            <View>
        ...
        <View style={styles.view5}>
          <View style={styles.view6}>
            ...
            <View>
              ...
              <Text style={{ color: colors.grey3 }}>Kimathi Street</Text>
            </View>
          </View>
          <View>
            <Icon
        ...
        <View style={{ ...styles.view5, borderBottomWidth: 0 }}>
          <View style={styles.view6}>
            ...
            <View>
              ...
              <Text style={{ color: colors.grey3 }}>City Stadium</Text>
            </View>
          </View>
          <View>
            <Icon
